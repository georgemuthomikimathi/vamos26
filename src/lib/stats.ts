...
export const TOP_ASSISTS: StatLeader[] = [
  ...
  { rank: 2, name: "Kevin De Bruyne", country: "Belgium", code: "be", club: "Napoli", value: 0, imageSlug: "kevin-de-bruyne" },
...
export const CLEAN_SHEETS: StatLeader[] = [
  ...
  { rank: 2, name: "Gianluigi Donnarumma", country: "Italy", code: "it", club: "Man City", value: 0, detail: "GK", imageSlug: "gianluigi-donnarumma" },
